-- ============================================================
-- Direct Aid 10x10 — ADD ADMIN ROLES (run AFTER setup-all.sql)
-- Safe to run on an existing database. Does NOT touch seed data.
...
-- Replace old open policies (from setup-all.sql) with role-based ones
...
-- You = Super Admin (change email if yours is different)
...
-- Link to existing Supabase auth account
