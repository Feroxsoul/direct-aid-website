...
export function CategoryListingHeader({ category }: CategoryListingHeaderProps) {
  ...
  return (
    <header className="w-full max-w-[var(--da-card-size)] px-5 pt-5">
      <div className="sub-box-container da-flex-row-reverse flex min-w-[var(--da-card-size)] items-center justify-between">
        <div className="sub-box-title flex flex-col items-end">
      ...
      <div
        className="category-box sub category-inbox mt-5 flex min-h-[120px] w-full max-w-[var(--da-card-size)] flex-col items-end justify-between overflow-hidden rounded-da-md bg-da-white text-da-black shadow-da-card"
